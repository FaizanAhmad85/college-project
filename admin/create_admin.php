...
<body>
<form name="form" method="post" action="save_admin.php">
    <table border="1" class="frm">
        <tr><td colspan="2" align="center" >Create Admin Account</td></tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="number" placeholder="enter your phone" id="phone" name="phone" required></td>
        </tr>
        <tr>
            <td><label for="address">Address</label></td>
            <td><textarea name="address" id="address" placeholder="enter your address" rows="3" cols="40" required></textarea></td>
        </tr>
        <tr><td colspan="2" align="center "><input type="submit" value="Create admin account" class="hov"

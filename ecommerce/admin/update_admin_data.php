...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE admin_account SET name='$name', password='$password', email='$email', gender='$gender', dob='$dob', phone='$phone', address='$address' WHERE acc_id=$acc_id";
...
if (isset($_GET['id'])) {
    ...
    $result = mysqli_query($con, "SELECT * FROM admin_account WHERE acc_id = $acc_id");
